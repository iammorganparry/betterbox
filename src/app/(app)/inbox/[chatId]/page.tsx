...
import { DevMessageTrigger } from "~/components/dev-message-trigger";
				...
				switch (attachment.attachment_type) {
					case "img":
						return (
							...
							>
								{/* First try R2 URL, then base64 content, finally fallback to Unipile URL */}
								{attachment.r2_url ? (
									<img
	...
	return (
		<>
			...
			<div className="flex h-full min-h-0 flex-col">
				...
				{/* Development Message Trigger */}
				{chatDetails && (
					<DevMessageTrigger
						chatId={chatId}
						accountId={chatDetails.unipileAccount?.id || ""}
						onMessageTriggered={() => {
							void refetchMessages();
							setTimeout(scrollToBottom, 100);
						}}
