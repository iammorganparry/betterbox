...
describe('UnipileAccountService', () => {
  ...
  describe('findByAccountId', () => {
    it('should find account without user when includeUser is false', async () => {
      ...
      drizzleMock.query.unipileAccounts.findFirst.mockResolvedValue(mockAccount);

      const result = await service.findByAccountId('linkedin-123', 'linkedin', false);
    ...
    it('should find account with user when includeUser is true', async () => {
      ...
      drizzleMock.query.unipileAccounts.findFirst.mockResolvedValue(mockAccountWithUser);

      const result = await service.findByAccountId('linkedin-123', 'linkedin', true);
  ...
  describe('findByUserId', () => {
    it('should find all accounts for a user', async () => {
      ...
      drizzleMock.query.unipileAccounts.findMany.mockResolvedValue(mockAccounts);
  ...
  describe('create', () => {
    it('should create a new account', async () => {
      ...
      drizzleMock.insert().values().returning.mockResolvedValue([createdAccount]);
  ...
  describe('update', () => {
    it('should update an account', async () => {
      ...
      drizzleMock.update().set().where().returning.mockResolvedValue([updatedAccount]);
  ...
  describe('delete', () => {
    it('should soft delete an account', async () => {
      ...
      drizzleMock.update().set().where().returning.mockResolvedValue([deletedAccount]);
