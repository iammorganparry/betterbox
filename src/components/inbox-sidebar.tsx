...
const SortableChatItem = ({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group relative flex w-full items-center border-border/50 border-b transition-all duration-200 last:border-b-0 ${
    ...
    >
      ...
      <button
        ...
        className="flex flex-1 flex-col items-start gap-3 whitespace-nowrap p-4 text-left text-sm leading-tight"
      >
        ...
        {mail.subject && (
          <span className="ml-[52px] line-clamp-1 font-medium text-muted-foreground text-xs">
            {mail.subject}
          </span>
        )}
        <span className="ml-[52px] line-clamp-2 w-[260px] whitespace-break-spaces text-muted-foreground text-xs leading-relaxed">
          {mail.teaser}
        </span>
      </button>
    ...
    >
      <div className="flex min-h-screen w-[450px] justify-center border-border border-r bg-background">
        <div className="w-full max-w-md">
          ...
          {/* Folders Section */}
          <div className="border-border border-b bg-card/50 p-4">
