		...
		<form onSubmit={handleSubmit} className="space-y-6">
			<Card>
				...
				<CardContent className="space-y-6">
					{/* Cost Breakdown */}
					<div className="glass-subtle space-y-4 rounded-lg p-4">
						<h3 className="font-semibold text-foreground">Cost Breakdown</h3>

						<div className="space-y-3">
							{/* Trial Period */}
							<div className="glass flex items-center justify-between rounded-md border border-primary/20 p-3">
								<div>
									<p className="flex items-center gap-2 font-medium text-foreground">
										7-Day Gold Trial
										<Badge variant="secondary" className="glass-subtle text-xs">
											Premium
										</Badge>
									</p>
							...
							{/* After Trial */}
							<div className="glass flex items-center justify-between rounded-md border border-border p-3">
								<div>
					...
					<div className="glass-subtle rounded-md border border-border p-3">
						<CardElement options={cardElementOptions} />
					</div>

					<div className="glass rounded-md border border-primary/20 p-4">
